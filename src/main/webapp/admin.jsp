        ...
        <%
          ...
          String url = "jdbc:mysql://ee417.crxkzf89o3fh.eu-west-1.rds.amazonaws.com:3306/testdb";
            try {
                ...
                String sqlstatement = "select first_name, email, date_of_birth, accountno, balance from usersGroupE";
    ...
    <table border="2px" class="tablecenter">
        ...
        <%
            ...
            try {
                ...
                Connection con= DriverManager.getConnection(url,usernames,password);
                Statement stmt=con.createStatement();
                String sqlstatement = "select first_name, email, message from contacttableGroupE";
                ResultSet rs = stmt.executeQuery(sqlstatement);
