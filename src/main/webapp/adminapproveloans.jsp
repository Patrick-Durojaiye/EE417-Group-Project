...
<div class="signup_section">
    <br>
    <h1> Welcome Admin you can approve loans here!!</h1>
    <br>
    <br>
    <section style=" background-image: linear-gradient(120deg, hsl(234, 70%, 51%),hsl(0, 0%, 57%)" class="reg-form">
        ...
        <div class="container2">
            ...
            <div class="content">
                ...
                <form id="form" method="post" action="ApproveLoanServlet">
    ...
    <table border="2px" class="tablecenter">
        ...
        String url = "jdbc:mysql://ee417.crxkzf89o3fh.eu-west-1.rds.amazonaws.com:3306/testdb";
            try {
                ...
                String sqlstatement = "select id, accountno, first_name, amount from loansGroupE";
