...
<div>
    ...
    <table border="2px" class="tablecenter">
        ...
        System.out.println("my account username is: " + username);
        ...
        String url = "jdbc:mysql://ee417.crxkzf89o3fh.eu-west-1.rds.amazonaws.com:3306/testdb";
            try {
                ...
                String sqlstatement = "select first_name, email, accountno, balance from usersGroupE where first_name='" + username + "'";
    ...
    <table border="2px" class="tablecenter">
        ...
        <%
            ...
            try {
                ...
                Connection con= DriverManager.getConnection(url,usernames,password);
                Statement stmt=con.createStatement();
                String sqlstatements = "select fromusername, accountno, amount from transferGroupE where fromusername='" + username + "'";
